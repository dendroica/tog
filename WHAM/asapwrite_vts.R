...
capture.output(write.table(asap[[1]]$dat$index_sel_ini[[4]], sep="\t", row.names=F, col.names=F)),
"# Index-1 Data",
...
"# Index-4 Data",
capture.output(write.table(asap[[1]]$dat$IAA_mats[[4]], sep="\t", row.names=F, col.names=F)),
"# Phase Control",
