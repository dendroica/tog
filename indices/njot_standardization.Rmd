...
source("C:\\Users\\galax\\OneDrive - New Jersey Office of Information Technology\\Documents\\data\\tog\\bootstrap_functions.R")
...
Read in data
```{r}
indata3 <- read.csv("C:\\Users\\galax\\OneDrive - New Jersey Office of Information Technology\\Documents\\data\\njot.csv", header = TRUE)

indata <- read_excel("C:\\Users\\galax\\OneDrive - New Jersey Office of Information Technology\\Documents\\data\\tog\\Tautog Data Template 2025_NJDEP.xlsx", sheet="Survey Tow Data", range = cell_rows(5:6246)) 
head(indata)
str(indata)
...
indata <- indata[indata$Year>1989,]
...
indata$YOY <- as.numeric(indata$TOTAL_NUMBER)
```
...
indata2 <- indata[is.element(as.numeric(substr(indata$CRUCODE,5,5)),5),]
