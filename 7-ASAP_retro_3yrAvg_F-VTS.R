...
asap <- file.path(root, "output/tog/asap/VTS")
...
#30% = 0.3318533
#40% = 0.201155
F_ref <- data.frame(BRP=c("Target", "Threshold"), value=c(0.197726475852373, 0.324995790032184))
...
# median of last 10 years 
SSB_ref <- data.frame(BRP=c("Target", "Threshold"), value=c(7987,6002))
