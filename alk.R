...
nj_comm <- read_excel("Tautog Data Template 2025_NJDEP.xlsx", sheet="CommBioSamples", range = cell_rows(6:682)) %>% mutate(Year = format(Year, '%Y'))
nj_comm24 <- read_excel("Tautog Data Template 2025_NJDEP_2024data.xlsx", sheet="CommBioSamples", range = cell_rows(6:239)) %>% mutate(Year = as.character(Year))
...
dmv21 <- read_excel("DMV_ALK_unfilled.xlsx", sheet="ALK_2021_unfilled")
dmv22 <- read_excel("DMV_ALK_unfilled.xlsx", sheet="ALK_2022_unfilled")
dmv23 <- read_excel("DMV_ALK_unfilled.xlsx", sheet="ALK_2023_unfilled")
dmv24 <- read_excel("DMV_ALK_unfilled.xlsx", sheet="ALK_2024_unfilled")
...
write.csv(nearfill[[1]], "NJNYB-ALK_2021_filled.csv")
write.csv(nearfill[[2]], "NJNYB-ALK_2022_filled.csv")
write.csv(nearfill[[3]], "NJNYB-ALK_2023_filled.csv")
write.csv(nearfill[[4]], "NJNYB-ALK_2024_filled.csv")
