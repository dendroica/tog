...
asap[[1]]$dat$index_units,
"# Age Proportion Index Units",
asap[[1]]$dat$index_acomp_units,
"# Weight at Age Matrix",
asap[[1]]$dat$index_WAA_pointers,
"# Index Month",
asap[[1]]$dat$index_month,
"# Index Selectivity Link to Fleet",
asap[[1]]$dat$index_sel_choice,
"# Index Selectivity Options 1=by age, 2=logisitic, 3=double logistic",
asap[[1]]$dat$index_sel_option
"# Index Start Age",
asap[[1]]$dat$index_sel_start_age,
"# Index End Age",
asap[[1]]$dat$index_sel_end_age,
"# Estimate Proportion (Yes=1)",
asap[[1]]$dat$use_index_acomp,
"# Use Index (Yes=1)",
asap[[1]]$dat$use_index,
"# Index-1 Selectivity Data",
asap[[1]]$dat$index_sel_ini[[1]],
"# Index-2 Selectivity Data",
asap[[1]]$dat$index_sel_ini[[2]],
"# Index-3 Selectivity Data",
asap[[1]]$dat$index_sel_ini[[3]],
"# Index-1 Data",
asap[[1]]$dat$IAA_mats[[1]],
"# Index-2 Data",
asap[[1]]$dat$IAA_mats[[2]],
"# Index-3 Data",
asap[[1]]$dat$IAA_mats[[3]],
"# Phase Control",
...
asap[[1]]$dat$lambda_q_devs,
"# CV for Catchability Deviations by Index",
asap[[1]]$dat$cv_q_devs,
