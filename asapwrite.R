...
"# Natural Mortality",
write.table(asap[[1]]$dat$M, sep="\t", row.names=F, col.names=F),
"# Fecundity Option",
asap[[1]]$dat$fec_opt,
"# Fraction of year that elapses prior to SSB calculation (0=Jan-1)",
asap[[1]]$dat$fracyr_spawn,
"# Maturity",
write.table(asap[[1]]$dat$maturity, sep="\t", row.names=F, col.names=F),
"# Number of Weights at Age Matrices",
asap[[1]]$dat$n_WAA_mats,
"# Weight Matrix - 1",
write.table(asap[[1]]$dat$WAA_mats[[1]], sep="\t", row.names=F, col.names=F),
"# Weight Matrix - 2",
write.table(asap[[1]]$dat$WAA_mats[[2]], sep="\t", row.names=F, col.names=F),
...
write.table(t(asap[[1]]$dat$sel_block_option), row.names=F, col.names=F),
"# Selectivity Block #1 Data",
write.table(asap[[1]]$dat$sel_ini[[1]], sep="\t", row.names=F, col.names=F),
"# Selectivity Block #2 Data",
write.table(asap[[1]]$dat$sel_ini[[2]], sep="\t", row.names=F, col.names=F),
"# Selectivity Block #3 Data",
write.table(asap[[1]]$dat$sel_ini[[3]], sep="\t", row.names=F, col.names=F),
"# Selectivity Block #4 Data",
write.table(asap[[1]]$dat$sel_ini[[4]], sep="\t", row.names=F, col.names=F),
"# Selectivity Block #5 Data",
write.table(asap[[1]]$dat$sel_ini[[5]], sep="\t", row.names=F, col.names=F),
"# Fleet Start Age",
asap[[1]]$dat$fleet_sel_start_age,
"# Fleet End Age",
asap[[1]]$dat$fleet_sel_end_age,
"# Age Range for Average F",
write.table(t(asap[[1]]$dat$Frep_ages), row.names=F, col.names=F),
...
"# Catch Data",
"# Fleet-1 Catch Data",
write.table(asap[[1]]$dat$CAA_mats[[1]], sep="\t", row.names=F, col.names=F),
"# Discards",
"# Fleet-1 Discards Data",
write.table(asap[[1]]$dat$DAA_mats[[1]], sep="\t", row.names=F, col.names=F),
"# Release Proportion",
"# Fleet-1 Release Data",
write.table(asap[[1]]$dat$prop_rel_mats[[1]], sep="\t", row.names=F, col.names=F),
"# Survey Index Data",
"# Aggregate Index Units",
write.table(t(asap[[1]]$dat$index_units), row.names=F, col.names=F),
"# Age Proportion Index Units",
write.table(t(asap[[1]]$dat$index_acomp_units), row.names=F, col.names=F),
"# Weight at Age Matrix",
write.table(t(asap[[1]]$dat$index_WAA_pointers), row.names=F, col.names=F),
"# Index Month",
write.table(t(asap[[1]]$dat$index_month), row.names=F, col.names=F),
"# Index Selectivity Link to Fleet",
write.table(t(asap[[1]]$dat$index_sel_choice), row.names=F, col.names=F),
"# Index Selectivity Options 1=by age, 2=logisitic, 3=double logistic",
write.table(t(asap[[1]]$dat$index_sel_option), row.names=F, col.names=F),
"# Index Start Age",
write.table(t(asap[[1]]$dat$index_sel_start_age), row.names=F, col.names=F),
"# Index End Age",
write.table(t(asap[[1]]$dat$index_sel_end_age), row.names=F, col.names=F),
"# Estimate Proportion (Yes=1)",
write.table(t(asap[[1]]$dat$use_index_acomp), row.names=F, col.names=F),
"# Use Index (Yes=1)",
write.table(t(asap[[1]]$dat$use_index), row.names=F, col.names=F),
"# Index-1 Selectivity Data",
write.table(asap[[1]]$dat$index_sel_ini[[1]], sep="\t", row.names=F, col.names=F),
"# Index-2 Selectivity Data",
write.table(asap[[1]]$dat$index_sel_ini[[2]], sep="\t", row.names=F, col.names=F),
"# Index-3 Selectivity Data",
write.table(asap[[1]]$dat$index_sel_ini[[3]], sep="\t", row.names=F, col.names=F),
"# Index-1 Data",
write.table(asap[[1]]$dat$IAA_mats[[1]], sep="\t", row.names=F, col.names=F),
"# Index-2 Data",
write.table(asap[[1]]$dat$IAA_mats[[2]], sep="\t", row.names=F, col.names=F),
"# Index-3 Data",
write.table(asap[[1]]$dat$IAA_mats[[3]], sep="\t", row.names=F, col.names=F),
"# Phase Control",
...
"# Lambdas by Index",
write.table(t(asap[[1]]$dat$lambda_index), row.names=F, col.names=F),
...
write.table(t(asap[[1]]$dat$lambda_q), row.names=F, col.names=F),
"# CV for Catchability in First year by Index",
write.table(t(asap[[1]]$dat$cv_q), row.names=F, col.names=F),
"# Lambda for Catchability Deviations by Index",
write.table(t(asap[[1]]$dat$lambda_q_devs), row.names=F, col.names=F),
"# CV for Catchability Deviations by Index",
write.table(t(asap[[1]]$dat$cv_q_devs), row.names=F, col.names=F),
...
write.table(t(asap[[1]]$dat$N1_ini), row.names=F, col.names=F),
"# Initial F Mult in 1st Year by Fleet",
asap[[1]]$dat$F1_ini,
"# Initial Catchabilty by Index",
write.table(t(asap[[1]]$dat$q_ini), row.names=F, col.names=F),
...
write.table(t(asap[[1]]$dat$proj_ini), row.names=F, col.names=F),
"# Do MCMC (Yes=1)",
asap[[1]]$dat$doMCMC,
"# MCMC Year Option",
